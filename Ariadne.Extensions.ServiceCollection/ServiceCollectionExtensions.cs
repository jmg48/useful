namespace Ariadne.Extensions.ServiceCollection
{
    ...
    {
        /// <summary>
        /// Add a factory service for <see cref="IFactory{TService}"/>, allowing other services to resolve instances of <see cref="TService"/> on demand.
        /// </summary>
        ...
        /// <summary>
        /// Add a factory service for <see cref="IFactory{T, TService}"/>, allowing other services to create instances of <see cref="TService"/> on demand.
        /// </summary>
        ...
        /// <summary>
        /// Add a factory service for <see cref="IFactory{T1, T2, TService}"/>, allowing other services to create instances of <see cref="TService"/> on demand.
        /// </summary>
        ...
        /// <summary>
        /// Add a factory service for <see cref="IFactory{T1, T2, T3, TService}"/>, allowing other services to create instances of <see cref="TService"/> on demand.
        /// </summary>
        /// <typeparam name="T1">The type of the first parameter used to create service instances.</typeparam>
        /// <typeparam name="T2">The type of the second parameter used to create service instances.</typeparam>
